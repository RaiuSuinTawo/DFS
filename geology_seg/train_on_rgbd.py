...
import dataset
from dataset.dataset_rgb_d import load_data_rgbd
...
def get_argparser():
    ...
    parser.add_argument("--data_dir", type=str, default="../../nyu_depth_v2_labeled.mat",
...
def main():
    #try:
        ...
        if ',' not in opts.crop_size:
            opts.crop_size = [int(opts.crop_size)]*2
        else:
            opts.crop_size = str2list(opts.crop_size)
        #print(opts.crop_size)
        #raise
        ...
        #print(opts.layers)
        #raise 
        train_loader, val_loader, nc = load_data_rgbd(opts.batch_size, opts.crop_size, opts.data_dir)
        
        model = modeling.__dict__[opts.model](num_classes = nc, 
        ...
        save_pre = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(opts.model, opts.data, opts.epoch, opts.lr, opts.batch_size, \
                                                opts.layers, opts.output_stride, opts.loss_type, opts.train_por, opts.fine_grained, opts.seed) if opts.fine_grained=='coarse' else '{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(opts.model, opts.data, opts.epoch, opts.lr, opts.batch_size, \
                                                opts.layers, opts.output_stride, opts.loss_type, opts.train_por, opts.seed)
