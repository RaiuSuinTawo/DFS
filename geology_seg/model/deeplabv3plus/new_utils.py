...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b0_backbone_weights.pth"), strict=False)
...
class mit_b1(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b1_backbone_weights.pth"), strict=False)
...
class mit_b2(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b2_backbone_weights.pth"), strict=False)
...
class mit_b3(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b3_backbone_weights.pth"), strict=False)
...
class mit_b4(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b4_backbone_weights.pth"), strict=False)
...
class mit_b5(MixVisionTransformer):
    def __init__(self, pretrained = False):
        ...
        if pretrained:
            print("Load backbone weights")
            self.load_state_dict(torch.load("model/deeplabv3plus/backbone/checkpoints/segformer_b5_backbone_weights.pth"), strict=False)
